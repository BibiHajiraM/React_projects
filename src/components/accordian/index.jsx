...
export default function Accordian() {
    ...
    function handleMultiSelection(getCurrentId) {
        ...
        const findIdxOfCurrentId = cpyMultiple.indexOf(getCurrentId)

        console.log(findIdxOfCurrentId)
        if (findIdxOfCurrentId === -1) cpyMultiple.push(getCurrentId)
        else cpyMultiple.splice(findIdxOfCurrentId, 1)
